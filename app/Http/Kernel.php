...
class Kernel extends HttpKernel
{
     ...
     *
     * Aliases may be used to conveniently assign middleware to routes and group.
     *
    ...
    protected $middlewareAliases = [
        ...
        'artists.accessor' => ArtistAccessorMiddleware::class,
        'user.accessor' => UserAccessorMiddleware::class,
    ];
}
